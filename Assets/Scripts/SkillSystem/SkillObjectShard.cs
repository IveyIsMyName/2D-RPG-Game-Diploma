...
public class SkillObjectShard : SkillObjectBase
{
    ...
    private SkillShard shardManager;
    ...
    public void SetupShard(SkillShard shardManager, float detonationTime, bool canMove, float shardSpeed, Transform target = null)
    {
        this.shardManager = shardManager;
